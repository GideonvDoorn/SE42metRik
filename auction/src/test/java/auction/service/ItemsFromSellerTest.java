...
//         assertEquals(0, user1.numberOfOfferedItems());
         ...
         *    In offerItem is een item toegevoegd aan de user, die daarna persisted is. Door de relatie in de user is dus een item aangemaakt in de db.
         */
...
//        assertEquals(3, userWithItem.numberOfOfferedItems());
         ...
         *  QUESTION:
         *    Explain the result in terms of entity manager and persistance context.
         *    the user that offered item2, offered two items. This has also been written to db, so the test which gets the user from the db passes
         */
...
//    @Ignore
    public void getItemsFromSeller() {
        ...
        //The user is retrieved from db to test if relations were written correctly
        //The second test tests for one item, which was ofered on line 97, so it passes
